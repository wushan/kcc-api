<div class="card">
    <div class="card-body card-padding">
        <div role="tabpanel">
            ...
            <form action="/news/update/{{$news->NewsID}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="input-group form-group col-sm-4">
                                ...
                                <div class="dtp-container">
                                    <input type='text' class="form-control date-picker " data-date-format="YYYY-MM-DD" placeholder="選擇日期" name="date" value="{{$news->date}}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-group form-group col-sm-4">
                                ...
                                <div class="dtp-container">
                                    <input type='text' class="form-control date-picker " data-date-format="YYYY-MM-DD"
                                           placeholder="選擇日期" name="exhibition_date"  value="{{$news->exhibition_date}}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="profile{{$lrow->Id}}">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    <div class="fg-line ">
                                        <input type="text" class="form-control input-lg" maxlength="100" placeholder="請輸入標題" name="langs[{{$lrow->Id}}][title]" value="{{$news->langs[$k]->title}}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    <div class="fg-line ">
                                        <input type="text" class="form-control input-lg" maxlength="200" placeholder="請輸入摘要" name="langs[{{$lrow->Id}}][intro]" value="{{$news->langs[$k]->intro}}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    <div class="fg-line ">
                                        <textarea placeholder="請輸入摘要" rows="10" cols="60" name="langs[{{$lrow->Id}}][content]" required>{{$news->langs[$k]->content}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
