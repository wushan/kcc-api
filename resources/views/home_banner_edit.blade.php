    ...
    <div class="card-body card-padding">
        <div role="tabpanel">
            <ul class="tab-nav" role="tablist">
                <li class="active"><a href="#home11" aria-controls="home11" role="tab" data-toggle="tab">修改Banner</a></li>
            </ul>
            <form action="/home/home_banner_edit/{{$banner->BannerID}}" method="post" enctype="multipart/form-data">
