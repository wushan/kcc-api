<div class="card">
    <div class="card-body card-padding">
        <div role="tabpanel">
            ...
            <form action="/product/product_application_product_add/{{$id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                ...
                <a href="/product/product_application_product/{{$id}}" class="btn btn-success btn-lg waves-effect">返回</a>
            </div>
            </form>
